...
class bertExtractor(baseTextExtractor):
    ...
    def tokenize(self, text):
        ...
        try:
            ...
            if text_bert['input_ids'].shape[1] > 512:
                #bert最多处理512个token
                text_bert['input_ids'] = text_bert['input_ids'][0:1,:512]
                text_bert['attention_mask'] = text_bert['attention_mask'][0:1,:512]
                text_bert['token_type_ids'] = text_bert['token_type_ids'][0:1,:512]
