...
class SELF_MM(nn.Module):
    ...
    def forward(self, text, audio, video):
        ...
        # print('org feat shape,', text.shape, audio.shape, video.shape)
        ...
        # print('mid1 feat shape,', text.shape, audio.shape, video.shape)
        # fusion
        ...
        # print('final feat shape,', text_h.shape, audio_h.shape, video_h.shape)
        res = {
            'M': output_fusion, 
            'T': output_text,
            'A': output_audio,
